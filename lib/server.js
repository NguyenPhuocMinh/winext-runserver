...
function Server(params = {}) {
  ...
  // options swagger
  const dialectSwagger = get(config, 'dialectSwagger', 'options');
          ...
          switch (dialectSwagger) {
            case SWAGGER_TYPE.OPTIONS: {
              if (isEmpty(swaggerOptions)) {
                ...
                loggerTracer.info(chalk.green.bold(`Api docs path: ${pathServer}/api-docs`));
              }
              break;
            }
            case SWAGGER_TYPE.YAML:
              if (isEmpty(swaggerYaml)) {
                ...
                loggerTracer.info(chalk.green.bold(`Api docs path: ${pathServer}pathServer/api-docs`));
              }
              break;
            default:
